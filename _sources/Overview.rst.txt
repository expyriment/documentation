...
*Website*: https://www.expyriment.org

*Authors:*

* `Florian Krause <https://www.floriankrause.org>`_, Donders Institute, RadboudUMC Nijmegen, The Netherlands
...
publication:
    ...
    416-428. `doi:10.3758/s13428-013-0390-6 <https://doi.org/10.3758/s13428-013-0390-6>`_
...
Forum
-----
The new official Expyriment support forum can be found at https://github.com/orgs/expyriment/discussions.


Matrix chat
-----------
To ask questions or to have real-time discussions with other users and the developers you can also use our `Matrix space <https://matrix.to/#/#expyriment-space:matrix.org>`_.


Social networks
---------------
* Follow `@expyriment <https://www.twitter.com/expyriment>`_ on Twitter
* Follow `Expyriment <https://www.facebook.com/expyriment>`_ on Facebook
* Follow `Expyriment <https://www.linkedin.com/company/expyriment>`_ on LinkedIn
